...
def fetch_user_info_from_api():
    try:
        ...
        logging.error(f"Error fetching user info from API: {e}")
        return {
            "user_id": 888888888,
            "name": "default user",
            "phone": "0000000000",
...
def get_db_connection():
    ...
    return mysql.connector.connect(
        host="77.37.35.26",
        user="u166985034_shary",
        password="kom9Ua9K3DRr[5Yf",
        database="u166985034_shary",
        port=3306,
        use_pure=True
    )
...
- استخدم `create_lead` لتسجيل بيانات العميل (مثل الاسم، رقم التليفون، البريد الإلكتروني، التفضيلات العقارية) في ملف Excel.
